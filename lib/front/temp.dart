...
/// input.
class TempDual extends StatefulWidget {
  final List<CameraDescription> cameras;

  TempDual({required this.cameras});

  @override
  _TempDualState createState() => _TempDualState();
}

class _TempDualState extends State<TempDual> {
  List<dynamic>? _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
...
class SquatData2 extends StatefulWidget {
  ...
  @override
  _SquatData2State createState() => _SquatData2State();
}

class _SquatData2State extends State<SquatData2> {
